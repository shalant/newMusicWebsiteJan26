...
- [ ] **Re-verify Realtime once the property has had time to activate** — not yet confirmed end-to-end (a real hit landing in GA4's Realtime report), just confirmed the client-side wiring is correct.
